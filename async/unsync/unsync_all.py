...
# will not be ran on an asyncio loop, nor a thread, will be seperated into processes!
...
# will be ran on an asyncio loop
@unsync()
...
# will be ran on a thread instead of an asyncio loop
@unsync()
